...
Hệ thống đã được triển khai chính thức tại: [https://smart-attendance-mocha.vercel.app/](https://smart-attendance-mocha.vercel.app/)
...
### 🧪 Hướng dẫn Test tính năng Chấm công (Check-in)
Do hệ thống có cơ chế bảo mật GPS/WiFi/IP nghiêm ngặt, để test thành công tính năng Chấm công trên thiết bị của bạn:
1. Đăng nhập bằng tài khoản **Admin**.
2. Vào mục **Quản lý Chi nhánh** -> Sửa một chi nhánh bất kỳ.
3. Bấm nút **"Lấy IP hiện tại của tôi"** để hệ thống tự điền IP mạng bạn đang dùng.
4. (Tùy chọn) Cập nhật Tên WiFi (SSID) và BSSID tương ứng với mạng bạn đang kết nối.
5. Save lại. Lúc này bạn có thể dùng tài khoản **Nhân viên** để thực hiện chấm công tại "Chi nhánh" vừa cấu hình.
